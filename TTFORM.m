...
INPUT(FA,CURRENT,COUNT)
 ...
 . I $P(ZB,$C(27),2)="[12~" S SUBFLG=1
 . I $P(ZB,$C(27),2)'="[12~" S SUBFLG=0
...
GETEXTVAL(FA,FIELDNAME)
 ...
 F  S ITEM=$O(FA("ITEMS",ITEM)) Q:ITEM=""  D
 . I FA("ITEMS",ITEM,"NAME")=FIELDNAME S RETVAL=FA("ITEMS",ITEM,"FIELD","VALUE")
 Q RETVAL

GETINTVAL(FA,FIELDNAME)
 N ITEM,RETVAL S (ITEM,RETVAL)=""
 F  S ITEM=$O(FA("ITEMS",ITEM)) Q:ITEM=""  D
 . I FA("ITEMS",ITEM,"NAME")=FIELDNAME S RETVAL=FA("ITEMS",ITEM,"FIELD","INTVAL")
 Q RETVAL