...
CHOOSE(CHOSEN,CAPTION)
 ...
 N EVENT,KEY,DISPLINES
 S DISPLINES=%IOCAP("ROWS")-5
...
REDISPLAY
 ...
 . I PGIDX=DISPLINES S PGNUM=PGNUM+1,PGIDX=1 E  S PGIDX=PGIDX+1
 . S OIDX=OIDX+1
 ;
 ...
 ; DRAW THE FOOTER
 ;
 D LOCATE^TTRNSI(%IOCAP("ROWS"),1),SETCOLOR^TTRNSI("MAGENTA","BLACK"),SETATTR^TTRNSI("BRIGHT")
