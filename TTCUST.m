...
SHOW
 ...
 . I $G(^TT("CUSTOMER",CUSTCODE,"INV",INVIDX,"UNITS"))'="" D
 . . W ?20,$J(^TT("CUSTOMER",CUSTCODE,"INV",INVIDX,"UNITS"),5,2)
 . I $G(^TT("CUSTOMER",CUSTCODE,"INV",INVIDX,"HOURS"))'="" D
 ...
 N PRCPAID 
 I TOTINV>0 S PRCPAID=(TOTPAID*100)/TOTINV D
