...
CREATE
 N FA
 S FA("TITLE")="NEW BILLING ENTRY"
 S FA("ITEMS",1,"NAME")="ITEM"
 S FA("ITEMS",1,"LABEL")="ITEM SOLD:"
 S FA("ITEMS",1,"LABEL","TOP")=4
 S FA("ITEMS",1,"LABEL","LEFT")=29
 ...
 S FA("ITEMS",3,"NAME")="UNITS"
 S FA("ITEMS",3,"LABEL")="UNITS:"
 ...
 S FA("ITEMS",4,"NAME")="UNITPRICE"
 S FA("ITEMS",4,"LABEL")="UNIT PRICE:"
 S FA("ITEMS",4,"LABEL","TOP")=10
 S FA("ITEMS",4,"LABEL","LEFT")=28
 S FA("ITEMS",4,"FIELD","TOP")=10
 S FA("ITEMS",4,"FIELD","LEFT")=40
 S FA("ITEMS",4,"FIELD","MAXLENGTH")=8
 S FA("ITEMS",4,"FIELD","REQUIRED")=1

 S FA("ITEMS",5,"NAME")="UNITTYPE"
 S FA("ITEMS",5,"LABEL")="UNIT TYPE:"
 S FA("ITEMS",5,"LABEL","TOP")=12
 S FA("ITEMS",5,"LABEL","LEFT")=29
 ...
 N UNITS,DATE,ITEM,CUSTCODE,ENTRIDX,CUSTREC,UNITPRICE,UNITTYPE
 S CUSTCODE=$$GETINTVAL^TTFORM(.FA,"CUSTOMER")
 S DATE=$$GETINTVAL^TTFORM(.FA,"DATE")
 S ITEM=$$GETEXTVAL^TTFORM(.FA,"ITEM")
 S UNITS=$$GETEXTVAL^TTFORM(.FA,"UNITS")
 S UNITPRICE=$$GETEXTVAL^TTFORM(.FA,"UNITPRICE")
 S UNITTYPE=$$GETEXTVAL^TTFORM(.FA,"UNITTYPE")
 S ENTRIDX=^TT("CUSTOMER",CUSTCODE,"ENTRIDX")
 TS
 S ^TT("ENTR",CUSTCODE,ENTRIDX,"UNITPRICE")=UNITPRICE
 S ^TT("ENTR",CUSTCODE,ENTRIDX,"UNITTYPE")=UNITTYPE
 S ^TT("ENTR",CUSTCODE,ENTRIDX,"UNITS")=UNITS
 S ^TT("ENTR",CUSTCODE,ENTRIDX,"DATE")=DATE
 S ^TT("ENTR",CUSTCODE,ENTRIDX,"ITEM")=ITEM
