...
KEYS
 S ^TT("XKEYS","XKIMP")="IMPERSONATE USER"
 S ^TT("XKEYS","XKADM")="IGLS ADMINISTRATION"
 S ^TT("XKEYS","XKGLS")="GENERAL LEDGER SYSTEM"
 S ^TT("XKEYS","XKINV")="INVOICING SYSTEM"
 S ^TT("XKEYS","XKCST")="CUSTOMER MANAGEMENT"
 S ^TT("XKEYS","XKTC")="TIME COLLECTION"
 Q